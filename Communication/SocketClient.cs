...
{
    public delegate void DelReceiveData(SocketClient sender, byte[] buf);
    public delegate void DelDisConnect(SocketClient sclient);
    public delegate void DelConnected(SocketClient sender);
    public class SocketClient
    {
        ...
        public SocketClient(string ip, int port, bool isReconn=true)
        {
            _remoteIp = ip;
            _remotePort = port;
